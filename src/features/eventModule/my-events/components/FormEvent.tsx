...
import { Button, Col, DatePicker, Form, Input, Row, Space, Checkbox, Select, Upload, UploadFile } from 'antd'
...
const FormEvent = ({ event, onSetValuesForm }: IEventFormProps) => {
    ...
    const [image, setImage] = useState<UploadFile | UploadFile[]>({} as UploadFile)
                    ...
                    <Col span={16}>
                        <Form form={form} onFinish={onSetDataForm} labelCol={{ span: 24 }} wrapperCol={{ span: 24 }}>
                            <Row>
                                ...
                                <Form.Item label='Agregar moderadores' name='haveModerators'>
